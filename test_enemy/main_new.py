...
class Enemy(Tank):
    ...
    def move_to_point(self, point, obstacles):
        """Движение к точке с избеганием препятствий"""
        old_x, old_y = self.rect.x, self.rect.y
...
def main():
    ...
    enemies = [Enemy(50, 50, RED, [(50, 50), (50, 350), (550, 350), (550, 50)])]
    ...
    while running:
        ...
        for enemy in enemies:
            ...
            # Линия от врага до игрока, когда игрок входит в радиус видимости
